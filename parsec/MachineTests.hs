...
test1 = TestCase  $ (assertEqual "const int 1" (Machine 0 [1,1] [] [IntVal 1] []) (compileAExpr expr1 (Machine 0 [] [] [] [])))

expr2 = (BoolConst True)

test2 = TestCase  $ (assertEqual "const bool true" (Machine 0 [1,1] [] [BoolVal True] []) (compileBExpr expr2 (Machine 0 [] [] [] [])))
